...
/**
 * Called when a {@link ServerPlayer} attempts to use a block by interacting.
 *
 * <p>Upon return:
 * <ul>
...
public interface BlockUseEvent {
    ...
    InteractionResult onUse(ServerPlayer player, InteractionHand hand, BlockHitResult hitResult);
}
